...
*   **💻 Editor en Pantalla Dividida (Split-Screen)**: Interfaz de pantalla dividida al 50% que permite editar tus posts en Markdown de un lado y ver la previsualización en vivo en el otro.
    * **📸 Inserción de Imágenes Inteligente (Insert Image)**: Un botón integrado en el pie del editor lateral te permite incorporar capturas de pantalla o fotos al instante.
    * **🔗 Inserción de Enlaces Relativos (Enlace)** — Botón en el pie del editor que abre un modal buscable con todos los artículos del repo. 
    * **🗑️ Eliminación de Artículos (Delete)** — con confirmación y redireccionamiento a la raíz
...
# 🚀 Cómo incorporar Hugo Deck a tu Servidor (Guía Rápida)
...
### 🛠️ Paso 3: Levantar el Contenedor
