...
{{< n8n_workflow src="/workflows/torrent_errors_synology_telegram.json" >}}
...
### Como funciona
- El primer paso es acceder al NAS mediante ssh para copiar el contenido del archivo "transmissiond.log" a una ubicación donde [n8n] lo pueda analizar. Esto se realiza mediante un bloque de comando
