...
Descargamos el paquete .deb desde la web de [KeepassXC] y lo instalamos manualmente o bien lo instalamos desde los repositorios de [Linux Mint]. Con esto ya puedo acceder a todos los nombres de usuario y contraseñas que tengo guardadas en una archivo de [Google Drive].
